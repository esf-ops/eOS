...
Never put pilot IDs, publication allowlist IDs, or emails in `VITE_*`.

**See also:** `PHASE_DE_2G_0_READINESS.md`, `PRIVATE_SYNTHETIC_DEPLOYMENT_RUNBOOK.md` (DE.2G.0 — do not execute gates).
