...
| **Tester** | _fill in_ |
| **Environment** | _local / staging / production — fill in_ |
...
|---|------|-------|--------|-------|
| H1 | Opens without console errors | [ ] | | |
| H2 | Workspace shows **organization name** (e.g. Elite Stone Fabrication), not raw UUID as primary label | [ ] | | |
| H3 | Workspace card shows **on slabOS**; org slug **not** shown on main card (slug OK in Access details only) | [ ] | | |
| H4 | Hero third stat: value = **job title** when set, else role; label = **Your role** | [ ] | | |
| H5 | User chip subtitle prefers job title / department / role (not only raw role) | [ ] | | |
| H6 | Assigned tools list loads (not fake "0" when API down) | [ ] | | |
| H7 | Open tool from launcher works | [ ] | | |
| H8 | User dropdown → **Profile & preferences** opens `?view=profile` | [ ] | | |
| H9 | Sign out works | [ ] | | |
...
|----|-------------|----------|---------|--------------|----------|--------|---------------------|--------|
| QA-001 | _example_ | P3 | _—_ | _—_ | _—_ | _—_ | _—_ | Open |
| | | | | | | | | |
