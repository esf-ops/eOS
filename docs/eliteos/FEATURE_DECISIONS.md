...
| **Out of scope** | View 222, Moraware/QB writes, identity changes, exposing SqFt in Account 360 UI. |
...
| **SqFt** | Same current set. Job Worksheet template + `Sq.Ft.` fields only. Not View 222. Not `moraware_raw_job_forms`. Account 360 UI still does not display SqFt. |
