...
- **Elite 100 Quote Flow** (**`app-elite100-quote-flow/`** — slug `elite100_quote_flow`; Brain `/api/elite100-quote-flow/*`; flag `ELITE100_QUOTE_FLOW_ENABLED`; clean Inbox → Estimate Queue (Set Scope) → Estimates staff head; **not** Estimate Studio / Studio V2; Slice 1C: Queue review + Set Scope)
