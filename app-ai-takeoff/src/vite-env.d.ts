...
interface ImportMetaEnv {
  ...
  /** Estimate Studio head URL — exact origin for Takeoff→Studio postMessage (AUDIT-005). */
  readonly VITE_HEAD_URL_ELITE100_ESTIMATE_STUDIO?: string;
  readonly VITE_HEAD_URL_ESTIMATE_STUDIO?: string;
