...
assert.ok(styles.includes("min-width: 320px") || styles.includes("min-width: 360px"));
assert.ok(styles.includes("min-width: 520px"));
assert.ok(styles.includes("ctr-col-piece"));
assert.ok(component.includes("data-testid=\"ctr-waterfall-toggle\"") || component.includes("ctr-waterfall-physical"));
assert.ok(component.includes("Length (in)"));
assert.ok(component.includes("Depth (in)"));
assert.ok(component.includes("ctr-col-dim--primary") || styles.includes("ctr-col-dim"));
