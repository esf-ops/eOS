...
function YesNoRow({
  ...
  return (
    <div className="takeoff-feedback-row">
      <span className="takeoff-feedback-label">{label}</span>
      <div className="takeoff-feedback-yesno">
        <button
          type="button"
...
export default function TakeoffFeedbackForm({
  ...
  if (submitted) {
    return (
      <div className="takeoff-feedback takeoff-feedback--done" role="status">
        <p>Thanks — beta feedback recorded.</p>
      </div>
    );
  }

  return (
    <form className="takeoff-feedback" onSubmit={handleSubmit}>
      <p className="takeoff-feedback-title">How was this AI takeoff?</p>
