...
export default function TakeoffIssueReportModal({
  ...
  return (
    <div className="takeoff-modal-backdrop" role="presentation" onClick={onClose}>
      <div className="takeoff-modal" role="dialog" aria-labelledby="takeoff-issue-title" onClick={(e) => e.stopPropagation()}>
        <h3 id="takeoff-issue-title">Report takeoff issue</h3>
        {done ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label>
              ...
              <input value={sourcePiece} onChange={(e) => setSourcePiece(e.target.value)} disabled={busy} placeholder="e.g. Kitchen run A, page 2" />
            </label>
            <label>
              Note
